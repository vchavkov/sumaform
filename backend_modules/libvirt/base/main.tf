...
locals {
  ...
  image_urls = {
    ...
    sles15sp2                = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles15sp2.x86_64.qcow2"
    sles15sp2o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-15-SP2-JeOS-GM/SLES15-SP2-JeOS.x86_64-15.2-OpenStack-Cloud-GM.qcow2"
    sles15sp3o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-15-SP3-JeOS-GM/SLES15-SP3-JeOS.x86_64-15.3-OpenStack-Cloud-GM.qcow2"
    sles15sp4o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-15-SP4-Minimal-GM/SLES15-SP4-Minimal-VM.x86_64-OpenStack-Cloud-GM.qcow2"
    sles15sp5o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-15-SP5-Minimal-GM/SLES15-SP5-Minimal-VM.x86_64-Cloud-GM.qcow2"
    sles15sp6o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-15-SP6-Minimal-GM/SLES15-SP6-Minimal-VM.x86_64-Cloud-GM.qcow2"
    sles12sp5o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-12-SP5-JeOS-GM/SLES12-SP5-JeOS.x86_64-12.5-OpenStack-Cloud-GM.qcow2"
    ...
    slemicro55o              = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/install/SLE-Micro-5.5/SLE-Micro.x86_64-5.5.0-Default-qcow-GM.qcow2"
    ...
    suma43VM-ign             = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/ibs/Devel:/Galaxy:/Manager:/4.3/images/SUSE-Manager-Server.x86_64-KVM-x86_64.qcow2"
